 ...
 */
	public function delete($id = null) {
		...
		if ($this->Enews->delete()) {
			$this->Session->setFlash(__('The enews has been deleted.'));
		} else {
			$this->Session->setFlash(__('The enews could not be deleted. Please, try again.'));
		}
		return $this->redirect(array('action' => 'index'));
	}
 ...
 */
	public function admin_edit($id = null) {
		...
		if ($this->request->is(array('post', 'put'))) {
			if ($this->Enews->save($this->request->data)) {
				$this->Session->setFlash(__('The enews has been saved.'));
				return $this->redirect(array('action' => 'index'));
			} else {
