<div class="portfolios index">
		...
		<div class="text-right" style='margin-bottom:10px;'>
			...
			<?php echo $this->Html->link(__("<i class='glyphicon glyphicon-plus'></i> Add Carousel"),array('action'=>'add'),
			...
			<table cellpadding="0" cellspacing="0" class="table table-striped">
				...
				<?php foreach ($carousels as $carousel): ?>
					<tr>
						...
						<td class="admin-edit-thumb img-thumbnail"><?php echo  $this->Html->image('../files/carousel/photo/' . $carousel['Carousel']['photo_dir'] . '/' . 'thumb_' .$carousel['Carousel']['photo'],
						array("url"=> array("controller"=>'carousels','action'=>'view',"slug"=>$carousel['Carousel']['slug'],"admin"=>false ))); ?></td>
						...
						<td><?php if($carousel['Carousel'][ 'online' ] == 0) {echo $this->Html->link(__('<span class="label label-danger">Offline</span>'),
							...
							array("style"=>"text-decoration:none;","data-toggle"=>"tooltip","data-placement"=>"bottom", "title"=>__('Enable this Carousel'),'escape'=>false));
							}else{
							echo $this->Html->link(__('<span class="label label-success">In line</span>'), array('action'=>'disable', $carousel['Carousel']['id']),
							array("style"=>"text-decoration:none;","data-toggle"=>"tooltip","data-placement"=>"bottom", "title"=>__('Disable this Post'),'escape'=>false));
							}
							?>
						</td>
						<td class="actions">
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-search"></span>', array('action' => 'view', $carousel['Carousel']['id']), array('class' => 'btn btn-default btn-sm','escape' => false)); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-edit" style="color:#00f;"></span>', array('action' => 'edit', $carousel['Carousel']['id']), array('class' => 'btn btn-default btn-sm','escape' => false)); ?>
							<?php // echo $this->Form->postLink('<span class="glyphicon glyphicon-trash"></span>', array('action' => 'delete', $carousel['Carousel']['id']), array ('escape' => false), __('Are you sure you want to delete # %s?', $carousel['Carousel']['id'])); ?>
							<?php echo $this->Html->link('<span class="glyphicon glyphicon-trash" style="color:#f00;"></span>','#Modal'.$carousel['Carousel']['id'],
              				array(
