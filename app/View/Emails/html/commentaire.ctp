		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>Bonjour</h3>
						<p class="lead"><b> <?= nl2br(h($name));?>  </b>a laissé un commentaire sur votre livre d'or:</p>
						<p><b>Email :</b> <?= nl2br(h($mail));?> </p>
						<p><b>message :</b></p>
						<!-- Callout Panel -->
						<p class="callout">
								<?= nl2br(h($content)); ?>
						</p><!-- /Callout Panel -->
						<p>Pour activer le message suivez ce lien : </p>
						<p><?= $this->Html->link('Activer ce commentaire',$this->Html->url(array(
								'controller' => 'comments', 'action' => 'activate', $id, $token),true)); ?>
						</p>
						<!-- social & contact -->
