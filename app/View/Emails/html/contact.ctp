	...
	<tr>
		...
		<td class="header container" >
			<div class="content">
				<table>
					<tr>
						<td ><img src="http://www.chateau-chazeron.com/img/logo.png" height="141px" width="141px" /></td>
						<td align="right"><h6 class="collapse">Studio</h6></td>
					</tr>
				</table>
			</div>
		</td>
		...
		<td class="container" bgcolor="#FFFFFF">
			...
			<table>
				<tr>
					<td>
						<h3>Bonjour</h3>
						<p class="lead"><b> <?= nl2br(h($name)) ; ?>  </b>Vous a contacté :</p>
						<p><b>Email :</b> <?= nl2br(h($email)) ; ?> </p>
						<p><b>Phone :</b> <a href="tel:<?= nl2br(h($phone)) ; ?>"><?= nl2br(h($phone)) ; ?></a> </p>
						<p><b>Mobile :</b> <a href="tel:<?= nl2br(h($mobile)) ; ?>"><?= nl2br(h($mobile)) ; ?></a></p>
						<p><b>Subject :</b> <?= nl2br(h($subject)) ; ?></p>
						<p><b>message</b></p>
						<!-- Callout Panel -->
						<p class="callout">
								<?= nl2br(h($message)); ?>
									...
									<table align="left" class="column">
										<tr>
											<td>
												...
												<p>Phone: <strong>00 00 00 00</strong><br/>
													<!-- Email: <strong><a href="mailto:vivianerichard06@chateau-chazeron.com">vivianerichard06@chateau-chazeron.com</a></strong> -->
												</p>
											</td>
										</tr>
									</table><!-- /column 2 -->
