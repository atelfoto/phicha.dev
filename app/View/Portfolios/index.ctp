...
<?php $this->Html->addCrumb('Portfolio',array("controller"=>"portfolio","action"=>"index"),array('class'=>"btn btn-default disabled")); ?>
<div class="container ">
	...
	<div class="row" >
		<?php  foreach ($portfolios as $portfolio): ?>
		  ...
		  <?=   $this->Html->image("../files/portfolio/photo/". $portfolio['Portfolio']['photo_dir']."/". 'port_'. $portfolio['Portfolio']['photo'],
		  	array("class" => "img-responsive ","width"=>"350","height"=>"262",'title'=>$portfolio['Portfolio']['name'] , 'url' =>
