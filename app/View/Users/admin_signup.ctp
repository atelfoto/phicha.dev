		...
		<div class="panel panel-info box-home">
			...
			<?= $this->Html->link(__('<i class="fa fa-times"></i>'),
				...
				array('class'=>'btn btn-xs close',
					...
					'escape'=>false)); ?>
				<h1 class="panel-title "><?php echo __("add user") ?></h1>
				...
				<?= $this->Form->create('User',array('action'=>'signup')); ?>
					<fieldset>
	    			    <div class="form-group">
	    			    	<label for="UserUsername"> <?= __('Username :'); ?> <i class="fa fa-asterisk"></i></label>
			    		...
			    		<div class="form-group">
	    			    	<label for="UserPassword"> <?= __('Password :'); ?> <i class="fa fa-asterisk"></i></label>
	    			    	<div class="input-group">
			    		...
			    		<div class="form-group">
	    			    	<label for="UserPassword2"> <?= __('Confirm Password :'); ?> <i class="fa fa-asterisk"></i></label>
	    			    	<div class="input-group">
			    		...
			    		<div class="form-group">
	    			    	<label for="UserMail"> <?= __('Email :'); ?> <i class="fa fa-asterisk"></i></label>
	    			    	<div class="input-group">
